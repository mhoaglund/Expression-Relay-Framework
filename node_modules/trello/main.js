...
Trello.prototype.getBoardFieldbyName = function (boardId, fieldname, callback) {
    return makeRequest(rest.get, this.uri + '/1/boards/' + boardId + '/' + fieldname, {query: this.createQuery()}, callback);
};
